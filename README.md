...
release builds include shell and Homebrew installers generated by
[`cargo-dist`](https://axodotdev.github.io/cargo-dist/).

```sh
# installer script
curl --proto '=https' --tlsv1.2 -LsSf https://github.com/objz/mcl/releases/latest/download/mcl-launcher-installer.sh | sh
...
release builds include a PowerShell installer and an MSI. WinGet and Chocolatey
packages are submitted from release CI and become available after repository
review.

```powershell
# installer script
powershell -ExecutionPolicy Bypass -c "irm https://github.com/objz/mcl/releases/latest/download/mcl-launcher-installer.ps1 | iex"
